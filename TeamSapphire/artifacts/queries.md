...
**111 queries · 934,006,552 rows read · 37,161 ms of ClickHouse time.**
...
|---:|---|---:|---:|
| 1 | `detect:revenue` | 1,680 | 38.9 ms |
| 2 | `detect:requests` | 1,680 | 39.7 ms |
| 3 | `detect:fill_rate` | 1,680 | 40.9 ms |
| 4 | `detect:ecpm` | 1,680 | 41.1 ms |
| 5 | `detect:ctr` | 1,680 | 40.3 ms |
| 6 | `detect_segments:revenue` | 107,520 | 202.3 ms |
| 7 | `detect_segments:requests` | 107,520 | 96.9 ms |
| 8 | `detect_segments:fill_rate` | 107,520 | 104.5 ms |
| 9 | `detect_segments:ecpm` | 107,520 | 127.3 ms |
| 10 | `detect_segments:ctr` | 107,520 | 101.6 ms |
| 11 | `baseline:data_range` | 1 | 30.3 ms |
| 12 | `decompose:window_vs_baseline` | 3,360 | 38.3 ms |
| 13 | `localize:fill_rate` | 215,040 | 45.7 ms |
| 14 | `characterize:fill_rate:os_version=Android 15` | 8,192 | 34.9 ms |
| 15 | `characterize:baseline:os_version=Android 15` | 8,192 | 35.0 ms |
| 16 | `baseline:data_range` | 1 | 31.0 ms |
| 17 | `decompose:window_vs_baseline` | 2,520 | 38.4 ms |
| 18 | `localize:requests` | 161,280 | 45.3 ms |
| 19 | `characterize:requests:global` | 840 | 36.2 ms |
| 20 | `characterize:baseline:global` | 840 | 33.6 ms |
| 21 | `baseline:data_range` | 1 | 31.4 ms |
| 22 | `decompose:window_vs_baseline` | 3,360 | 41.1 ms |
| 23 | `localize:requests` | 215,040 | 49.0 ms |
| 24 | `characterize:requests:global` | 840 | 35.8 ms |
| 25 | `characterize:baseline:global` | 840 | 36.0 ms |
| 26 | `baseline:data_range` | 1 | 35.6 ms |
| 27 | `decompose:window_vs_baseline` | 2,520 | 38.0 ms |
| 28 | `localize:requests` | 161,280 | 46.5 ms |
| 29 | `characterize:requests:global` | 840 | 35.4 ms |
| 30 | `characterize:baseline:global` | 840 | 33.6 ms |
| 31 | `baseline:data_range` | 1 | 30.9 ms |
| 32 | `decompose:window_vs_baseline` | 2,520 | 36.2 ms |
| 33 | `localize:requests` | 161,280 | 46.7 ms |
| 34 | `characterize:requests:global` | 840 | 37.2 ms |
| 35 | `characterize:baseline:global` | 840 | 40.7 ms |
| 36 | `baseline:data_range` | 1 | 32.6 ms |
| 37 | `decompose:window_vs_baseline` | 2,520 | 44.7 ms |
| 38 | `localize:requests` | 161,280 | 47.5 ms |
| 39 | `characterize:requests:category=gaming` | 8,192 | 39.6 ms |
| 40 | `characterize:baseline:category=gaming` | 8,192 | 40.9 ms |
| 41 | `baseline:data_range` | 1 | 32.4 ms |
| 42 | `decompose:window_vs_baseline` | 3,360 | 40.3 ms |
| 43 | `localize:requests` | 215,040 | 46.1 ms |
| 44 | `characterize:requests:publisher_tier=tier_1` | 8,192 | 35.5 ms |
| 45 | `characterize:baseline:publisher_tier=tier_1` | 8,192 | 38.8 ms |
| 46 | `baseline:data_range` | 1 | 36.3 ms |
| 47 | `decompose:window_vs_baseline` | 3,360 | 44.1 ms |
| 48 | `localize:requests` | 215,040 | 47.1 ms |
| 49 | `characterize:requests:device_model=iPhone 15` | 8,192 | 34.9 ms |
| 50 | `characterize:baseline:device_model=iPhone 15` | 8,192 | 33.9 ms |
| 51 | `baseline:data_range` | 1 | 31.0 ms |
| 52 | `decompose:window_vs_baseline` | 2,520 | 39.0 ms |
| 53 | `localize:requests` | 161,280 | 47.3 ms |
| 54 | `characterize:requests:campaign_type=CPM` | 8,192 | 38.5 ms |
| 55 | `characterize:baseline:campaign_type=CPM` | 8,192 | 33.1 ms |
| 56 | `baseline:data_range` | 1 | 40.7 ms |
| 57 | `decompose:window_vs_baseline` | 3,360 | 51.6 ms |
| 58 | `localize:requests` | 215,040 | 60.0 ms |
| 59 | `characterize:requests:global` | 840 | 34.6 ms |
| 60 | `characterize:baseline:global` | 840 | 35.8 ms |
| 61 | `baseline:data_range` | 1 | 32.1 ms |
| 62 | `decompose:window_vs_baseline` | 4,200 | 42.6 ms |
| 63 | `localize:requests` | 268,800 | 60.2 ms |
| 64 | `characterize:requests:global` | 840 | 33.0 ms |
| 65 | `characterize:baseline:global` | 840 | 31.7 ms |
| 66 | `baseline:data_range` | 1 | 30.3 ms |
| 67 | `decompose:window_vs_baseline` | 2,520 | 35.9 ms |
| 68 | `localize:requests` | 161,280 | 44.5 ms |
| 69 | `characterize:requests:ad_format=native` | 8,192 | 35.5 ms |
| 70 | `characterize:baseline:ad_format=native` | 8,192 | 32.9 ms |
| 71 | `baseline:data_range` | 1 | 30.0 ms |
| 72 | `decompose:window_vs_baseline` | 4,200 | 41.4 ms |
| 73 | `localize:requests` | 268,800 | 59.7 ms |
| 74 | `characterize:requests:publisher_tier=tier_3` | 8,192 | 35.6 ms |
| 75 | `characterize:baseline:publisher_tier=tier_3` | 8,192 | 35.7 ms |
| 76 | `baseline:data_range` | 1 | 31.8 ms |
| 77 | `decompose:window_vs_baseline` | 2,520 | 39.3 ms |
| 78 | `localize:ecpm` | 161,280 | 44.8 ms |
| 79 | `characterize:ecpm:category=finance` | 8,192 | 35.7 ms |
| 80 | `characterize:baseline:category=finance` | 8,192 | 33.0 ms |
| 81 | `baseline:data_range` | 1 | 29.5 ms |
| 82 | `decompose:window_vs_baseline` | 4,200 | 41.0 ms |
| 83 | `localize:requests` | 268,800 | 54.0 ms |
| 84 | `characterize:requests:device_model=iPhone 15` | 8,192 | 36.0 ms |
| 85 | `characterize:baseline:device_model=iPhone 15` | 8,192 | 32.6 ms |
| 86 | `baseline:data_range` | 1 | 35.1 ms |
| 87 | `decompose:window_vs_baseline` | 4,200 | 43.0 ms |
| 88 | `localize:requests` | 268,800 | 55.9 ms |
| 89 | `characterize:requests:global` | 840 | 40.3 ms |
| 90 | `characterize:baseline:global` | 840 | 32.8 ms |
| 91 | `scan_intersect:regionxdevice_model` | 44,284,320 | 1706.3 ms |
| 92 | `scan_intersect:regionxos_version` | 44,284,320 | 1625.4 ms |
| 93 | `scan_intersect:regionxcategory` | 44,284,320 | 1845.6 ms |
| 94 | `scan_intersect:regionxpublisher_tier` | 44,284,320 | 1767.2 ms |
| 95 | `scan_intersect:regionxad_format` | 44,284,320 | 1247.2 ms |
| 96 | `scan_intersect:regionxcountry` | 44,284,320 | 1476.6 ms |
| 97 | `scan_intersect:device_modelxos_version` | 44,284,320 | 1519.9 ms |
| 98 | `scan_intersect:device_modelxcategory` | 44,284,320 | 1991.2 ms |
| 99 | `scan_intersect:device_modelxpublisher_tier` | 44,284,320 | 1739.1 ms |
| 100 | `scan_intersect:device_modelxad_format` | 44,284,320 | 1296.6 ms |
| 101 | `scan_intersect:device_modelxcountry` | 44,284,320 | 1608.5 ms |
| 102 | `scan_intersect:os_versionxcategory` | 44,284,320 | 1744.8 ms |
| 103 | `scan_intersect:os_versionxpublisher_tier` | 44,284,320 | 1649.2 ms |
| 104 | `scan_intersect:os_versionxad_format` | 44,284,320 | 1248.1 ms |
| 105 | `scan_intersect:os_versionxcountry` | 44,284,320 | 1564.1 ms |
| 106 | `scan_intersect:categoryxpublisher_tier` | 44,284,320 | 1694.8 ms |
| 107 | `scan_intersect:categoryxad_format` | 44,284,320 | 1318.1 ms |
| 108 | `scan_intersect:categoryxcountry` | 44,284,320 | 1778.4 ms |
| 109 | `scan_intersect:publisher_tierxad_format` | 44,284,320 | 1463.2 ms |
| 110 | `scan_intersect:publisher_tierxcountry` | 44,284,320 | 1676.6 ms |
| 111 | `scan_intersect:ad_formatxcountry` | 44,284,320 | 1252.0 ms |

---

## `baseline:data_range` — 16 call(s)
...
## `decompose:window_vs_baseline` — 16 call(s)
...
## `localize:requests` — 14 call(s)

161,280 rows · 45.3 ms

```sql
SELECT 0 AS weeks_back, dim_name, dim_value, sum(requests) AS requests, sum(fills) AS fills, sum(impressions) AS impressions, sum(clicks) AS clicks, sum(revenue) AS revenue FROM inmobi.events_hourly_by_dim WHERE hour >= {start:DateTime} AND hour <= {end:DateTime} GROUP BY dim_name, dim_value UNION ALL SELECT 1 AS weeks_back, dim_name, dim_value, sum(requests), sum(fills), sum(impressions), sum(clicks), sum(revenue) FROM inmobi.events_hourly_by_dim WHERE hour >= {start:DateTime} - toIntervalWeek(1) AND hour <= {end:DateTime} - toIntervalWeek(1) GROUP BY dim_name, dim_value UNION ALL SELECT 2 AS weeks_back, dim_name, dim_value, sum(requests), sum(fills), sum(impressions), sum(clicks), sum(revenue) FROM inmobi.events_hourly_by_dim WHERE hour >= {start:DateTime} - toIntervalWeek(2) AND hour <= {end:DateTime} - toIntervalWeek(2) GROUP BY dim_name, dim_value
```

215,040 rows · 49.0 ms

```sql
SELECT 0 AS weeks_back, dim_name, dim_value, sum(requests) AS requests, sum(fills) AS fills, sum(impressions) AS impressions, sum(clicks) AS clicks, sum(revenue) AS revenue FROM inmobi.events_hourly_by_dim WHERE hour >= {start:DateTime} AND hour <= {end:DateTime} GROUP BY dim_name, dim_value UNION ALL SELECT 1 AS weeks_back, dim_name, dim_value, sum(requests), sum(fills), sum(impressions), sum(clicks), sum(revenue) FROM inmobi.events_hourly_by_dim WHERE hour >= {start:DateTime} - toIntervalWeek(1) AND hour <= {end:DateTime} - toIntervalWeek(1) GROUP BY dim_name, dim_value UNION ALL SELECT 2 AS weeks_back, dim_name, dim_value, sum(requests), sum(fills), sum(impressions), sum(clicks), sum(revenue) FROM inmobi.events_hourly_by_dim WHERE hour >= {start:DateTime} - toIntervalWeek(2) AND hour <= {end:DateTime} - toIntervalWeek(2) GROUP BY dim_name, dim_value UNION ALL SELECT 3 AS weeks_back, dim_name, dim_value, sum(requests), sum(fills), sum(impressions), sum(clicks), sum(revenue) FROM inmobi.events_hourly_by_dim WHERE hour >= {start:DateTime} - toIntervalWeek(3) AND hour <= {end:DateTime} - toIntervalWeek(3) GROUP BY dim_name, dim_value
```

268,800 rows · 60.2 ms
